...
<head>
	...
	<title>Documentation Class: PfTab</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: PfTab</h1>
<section>
...
<header>
        ...
        PfTab
            ...
            <div class="class-description"><p><b>&lt;pf-tab&gt;</b> element for Patternfly Web Components</p></div>
...
<hr>
<dt>
    <h4 class="name" id="PfTab"><span class="type-signature"></span>new PfTab()</h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>if attribute exists, tab will be active</p></td>
        </tr>
...
<hr>
<dt class="name" id="active">
    <h4 id="active"><span class="type-signature"></span>active<span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Set flag indicating tab is active</p>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Get flag indicating tab is active</p>
    </div>
...
<hr>
<dt class="name" id="title">
    <h4 id="title"><span class="type-signature"></span>title<span class="type-signature"></span></h4>
