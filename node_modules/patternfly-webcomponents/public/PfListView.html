...
<head>
	...
	<title>Documentation Class: PfListView</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: PfListView</h1>
<section>
...
<header>
        ...
        PfListView
            ...
            <div class="class-description"><p><b>&lt;pf-list-view&gt;</b> element for Patternfly Web Components</p></div>
...
<hr>
<dt>
    <h4 class="name" id="PfListView"><span class="type-signature"></span>new PfListView()</h4>
...
<table class="props table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>show-checkboxes</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>whether to show list-view checkboxes</p></td>
        </tr>
...
<hr>
<dt>
    <h4 class="name" id="handleRepeaterContentChanged"><span class="type-signature"></span>handleRepeaterContentChanged()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Called when repeater content changes (updates content)</p>
    </div>
...
<hr>
<dt>
    <h4 class="name" id="updateComponent"><span class="type-signature"></span>updateComponent()</h4>
...
<dd>
    ...
    <div class="description">
        <p>This method updates the overall list view and each repeated row/item in the list.</p>
    </div>
